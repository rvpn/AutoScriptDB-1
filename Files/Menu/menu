...
echo "--------------- Welcome To Premium Script Menu ---------------"
	...
	echo -e " "
	echo -e "-----=[ VPS Section ]=-----"
	echo -e "${color1}23${color3}.Speedtest Server (${color2}speedtest --share${color3})"
	echo -e "${color1}24${color3}.Benchmark Server (${color2}bench-network${color3})"
	echo -e "${color1}25${color3}.Check Server RAM Usage (${color2}ram${color3})"
